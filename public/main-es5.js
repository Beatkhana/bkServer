...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _tournaments_tournaments_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(titleService, http, route, router) {
        var _this = this;
        ...
        this.route.queryParams.subscribe(function (params) {// if (params['code']) {
          // }
        });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _tournaments_tournaments_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./tournaments/tournaments.component */
    "./src/app/tournaments/tournaments.component.ts");
    /* harmony import */
  ...
  function srcAppArchiveArchiveComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ArchiveComponent = /*#__PURE__*/function (_app_component__WEBPA) {
      ...
      function ArchiveComponent() {
        ...
        _this2.title = "BeatKhana!";
        _this2.url = '/api/tournament/archived';
        _this2.tournaments = [];
        return _this2;
      }
      ...
      _createClass(ArchiveComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.getTournaments().subscribe(function (data) {
            return _this3.tournaments = data;
          });
  ...
  function srcAppTournamentTournamentComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function TournamentComponent_div_0_span_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TournamentComponent_div_0_span_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
      ...
      if (rf & 2) {
        var tournament_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function TournamentComponent_div_0_span_15_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TournamentComponent_div_0_ng_template_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TournamentComponent_div_0_span_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function TournamentComponent_div_0_span_19_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    var TournamentComponent = /*#__PURE__*/function (_app_component__WEBPA2) {
      ...
      function TournamentComponent() {
        ...
        _this4.title = "BeatKhana!";
        _this4.url = '/api/tournament';
        _this4.tournaments = [];
        return _this4;
      }
      ...
      _createClass(TournamentComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.paramMap.subscribe(function (params) {
            _this5.tourneyId = params.get('id');
            console.log(_this5.tourneyId);

            _this5.getTournaments().subscribe(function (data) {
              _this5.tournaments = data;
              console.log(data);

              _this5.setTitle(_this5.tournaments[0].name + ' | ' + _this5.title);
            });
    ...
    TournamentComponent.ɵfac = function TournamentComponent_Factory(t) {
      return ɵTournamentComponent_BaseFactory(t || TournamentComponent);
    };
    ...
    TournamentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "container", 4, "ngFor", "ngForOf"], [1, "container"], [1, "card", "noHover"], [1, "card-body"], ["alt", "", 1, "tourneyImg", 3, "src"], [1, "card-text"], [4, "ngIf"], [4, "ngIf", "ngIfElse"], ["noPrize", ""], ["target", "new", 3, "href"]],
    ...
    var ɵTournamentComponent_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetInheritedFactory"](TournamentComponent);
    /*@__PURE__*/
  ...
  function srcAppTournamentsTournamentsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function TournamentsComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var tournament_r2 = ctx.$implicit;
    ...
    function TournamentsComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 3);
    ...
    var TournamentsComponent = /*#__PURE__*/function (_app_component__WEBPA3) {
      ...
      function TournamentsComponent() {
        ...
        _this6.title = "BeatKhana!";
        _this6.url = '/api/tournaments';
        _this6.tournaments = [];
        return _this6;
      }
      ...
      _createClass(TournamentsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.getTournaments().subscribe(function (data) {
            return _this7.tournaments = data;
          });
          this.setTitle(this.title);
    ...
    TournamentsComponent.ɵfac = function TournamentsComponent_Factory(t) {
      return ɵTournamentsComponent_BaseFactory(t || TournamentsComponent);
    };
    ...
    TournamentsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 2,
      consts: [[1, "container", "grid"], ["class", "card", 4, "ngFor", "ngForOf"], ["class", "card", 4, "ngIf"], [1, "card"], [1, "btn-reload", 3, "title", "routerLink"], [1, "card-img-top", 3, "src"], [1, "card-title"], [1, "card-text"], ["href", "<?= $tournament->signup ?>"], [1, "btn-reload"], [1, "fas", "fa-plus-circle", "card-img-top", 2, "font-size", "200px", "outline", "2px solid #c8825a"]],
    ...
    var ɵTournamentsComponent_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetInheritedFactory"](TournamentsComponent);
    /*@__PURE__*/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/dan/webDev/angular1/app/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
